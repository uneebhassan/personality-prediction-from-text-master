...
>>>>>>> 20589f3776a09132bb57768a06aa5ce6ae6a32e3
        ...
        #self.browser.implicitly_wait(30) # seconds
        self.number_of_friends = 3
        print(self.number_of_friends)
        # Get scroll height
        ...
        while len(self.friends_dict.items()) < self.number_of_friends:
            ...
            # Grab all friends
            friend_items = self.browser.find_elements_by_class_name('ue3kfks5')
            print(friend_items)
    ...
    def scrape_friends_statuses(self):
        ...
        #     if person not in DB
            ...
            while len(statuses_dict.items()) < self.number_of_statuses:
                ...
                posts = self.browser.find_elements_by_class_name('sbcfpzgs')
...
if __name__ == '__main__':
    with open('fb_login_creds.yaml', 'r') as stream:
        try:
            y = yaml.load(stream,yaml.SafeLoader)
